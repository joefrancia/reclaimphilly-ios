...
#pragma mark TODO Error handling
    ...
    if (!self.picture1 && !self.picture2 && !self.picture3) {
        [[RPHTTPClient sharedInstance] postPath:postURL
        ...
        NSMutableURLRequest *req = [[RPHTTPClient sharedInstance]
        ...
        [[RPHTTPClient sharedInstance] enqueueHTTPRequestOperation:op];
    }
